...
// ADD LIGHTS
const ambientLight = new THREE.AmbientLight(0x00DDFF)
scene.add(ambientLight)

const directionalLight = new THREE.DirectionalLight(0xff521b, 0.6) // light like sun direction
...
let earth = null // this varible is null, because we haven't load the object yet
...
const animate = function () {
  if (earth) { // if earth is not null rotate
    earth.rotateY(0.01)
  }
